...
import com.example.appFinal.databinding.ActivityPokemonBinding
        ...
        sortedQuery.addChildEventListener(object : ChildEventListener {
            override fun onChildAdded(snapshot: DataSnapshot, previousChildName: String?) {
                ...
                if (values != null) {
                    ...
                    //文章區塊顯示容器
                    val contentContainer = LinearLayout(this@Pokemon)
                    ...
                    //顯示使用者名稱
                    val usernameTextView = TextView(this@Pokemon)
                    ...
                    val font = ResourcesCompat.getFont(this@Pokemon, R.font.roboto)// 設置使用者名稱的字體型態
                    ...
                    // 文章內容
                    val contentTextView = TextView(this@Pokemon)
                    ...
                    // 按讚次數和按讚按鈕的容器
                    val likesContainer = LinearLayout(this@Pokemon)
                    likesContainer.orientation = LinearLayout.HORIZONTAL
                    likesContainer.layoutParams = LinearLayout.LayoutParams(
                        LinearLayout.LayoutParams.MATCH_PARENT,
                        LinearLayout.LayoutParams.WRAP_CONTENT
                    )
                    likesContainer.setBackgroundResource(R.drawable.post_bg) // 設定貼文區塊的背景

                    // 按讚次數
                    val likeTextview = TextView(this@Pokemon)
                    ...
                    // 按讚按鈕
                    val likeButton = ImageButton(this@Pokemon)
                    var isLiked = false
                    ...
                    //顯示發文時間
                    val dateTextView = TextView(this@Pokemon)
                    ...
                    // 分隔線
                    val separatorView = View(this@Pokemon)
                    ...
                    // 創建貼文區塊容器
                    val postContainer = LinearLayout(this@Pokemon)
