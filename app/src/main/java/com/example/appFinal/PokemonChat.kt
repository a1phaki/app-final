...
import com.example.appFinal.databinding.ActivityPokemonChatBinding
...
class PokemonChat : AppCompatActivity() {

    //初始化
    private  lateinit var  auth: FirebaseAuth
    private  lateinit var  binding: ActivityPokemonChatBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        binding = ActivityPokemonChatBinding.inflate(layoutInflater)
        ...
        sortedQuery.addChildEventListener(object :ChildEventListener{
            override fun onChildAdded(snapshot: DataSnapshot, previousChildName: String?) {
                ...
                if (values != null) {
                    ...
                    // 使用者名稱和日期的容器
                    val nameContainer = LinearLayout(this@PokemonChat)
                    ...
                    //顯示使用者名稱
                    val usernameTextView = TextView(this@PokemonChat)
                    ...
                    val font = ResourcesCompat.getFont(this@PokemonChat, R.font.roboto)// 設置使用者名稱的字體型態
                    ...
                    //顯示發文時間
                    val dateTextView = TextView(this@PokemonChat)
                    ...
                    // 顯示訊息區塊的容器
                    val contentContainer = LinearLayout(this@PokemonChat)
                    ...
                    // 訊息內容
                    val contentTextView = TextView(this@PokemonChat)
                    ...
                    // 創建訊息區塊容器
                    val postContainer = LinearLayout(this@PokemonChat)
