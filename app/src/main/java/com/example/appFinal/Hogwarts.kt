...
import com.example.appFinal.databinding.ActivityHogwartsBinding
...
class Hogwarts : AppCompatActivity() {

    //初始化
    private lateinit var  auth: FirebaseAuth
    private lateinit var  binding: ActivityHogwartsBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        binding = ActivityHogwartsBinding.inflate(layoutInflater)
        ...
        sortedQuery.addChildEventListener(object : ChildEventListener {
            override fun onChildAdded(snapshot: DataSnapshot, previousChildName: String?) {
                ...
                if (values != null) {
                    ...
                    //文章區塊顯示容器
                    val contentContainer = LinearLayout(this@Hogwarts)
                    ...
                    //顯示使用者名稱
                    val usernameTextView = TextView(this@Hogwarts)
                    ...
                    val font = ResourcesCompat.getFont(this@Hogwarts, R.font.roboto)// 設置使用者名稱的字體型態
                    ...
                    // 文章內容
                    val contentTextView = TextView(this@Hogwarts)
                    ...
                    // 按讚次數和按讚按鈕的容器
                    val likesContainer = LinearLayout(this@Hogwarts)
                    ...
                    // 按讚次數
                    val likeTextview = TextView(this@Hogwarts)
                    ...
                    // 按讚按鈕
                    val likeButton = ImageButton(this@Hogwarts)
                    var isLiked = false
                    ...
                    //顯示發文時間
                    val dateTextView = TextView(this@Hogwarts)
                    ...
                    // 分隔線
                    val separatorView = View(this@Hogwarts)
                    ...
                    // 創建貼文區塊容器
                    val postContainer = LinearLayout(this@Hogwarts)
