...
import com.example.appFinal.databinding.ActivityEldenringBinding
...
class Eldenring : AppCompatActivity() {

    //初始化
    private lateinit var  auth: FirebaseAuth
    private lateinit var  binding: ActivityEldenringBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        binding = ActivityEldenringBinding.inflate(layoutInflater)
        ...
        sortedQuery.addChildEventListener(object : ChildEventListener {
            override fun onChildAdded(snapshot: DataSnapshot, previousChildName: String?) {
                ...
                if (values != null) {
                    ...
                    //文章區塊顯示容器
                    val contentContainer = LinearLayout(this@Eldenring)
                    ...
                    //顯示使用者名稱
                    val usernameTextView = TextView(this@Eldenring)
                    ...
                    val font = ResourcesCompat.getFont(this@Eldenring, R.font.roboto)// 設置使用者名稱的字體型態
                    ...
                    // 文章內容
                    val contentTextView = TextView(this@Eldenring)
                    ...
                    // 按讚次數和按讚按鈕的容器
                    val likesContainer = LinearLayout(this@Eldenring)
                    ...
                    // 按讚次數
                    val likeTextview = TextView(this@Eldenring)
                    ...
                    // 按讚按鈕
                    val likeButton = ImageButton(this@Eldenring)
                    var isLiked = false
                    ...
                    //顯示發文時間
                    val dateTextView = TextView(this@Eldenring)
                    ...
                    // 分隔線
                    val separatorView = View(this@Eldenring)
                    ...
                    // 創建貼文區塊容器
                    val postContainer = LinearLayout(this@Eldenring)
